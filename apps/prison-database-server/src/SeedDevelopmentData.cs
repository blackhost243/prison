...
using PrisonDatabase.Infrastructure;
using PrisonDatabase.Infrastructure.Models;
...
public class SeedDevelopmentData
{
    ...
    {
        var context = serviceProvider.GetRequiredService<PrisonDatabaseDbContext>();
        var userStore = new UserStore<IdentityUser>(context);
        var usernameValue = "blackhost108@gmail.com";
        var passwordValue = "Asu@&1234";
